...
import { uploadToBlob, deleteBlobFromAzure, removeFileExtension } from "../lib/utils/blobService";
...
class MeshService {
    ...
    async uploadMesh(textureImg: any, screenShot: any, meshType): Promise<IMesh> {
        ...
        const meshData: any = {
            meshType,
            name: await removeFileExtension(textureImg?.originalname), // Extract the name from the texture file
